param(
    ...
    [string]$GameLocalFolder = "C:\Users\thier\AppData\Local\BG3ScriptExtender\ScriptExtender\27.0.0.0_71ff8a4895c9f6c9554aa0bc9e093600484c33f2bde45b688983aacb5d024215"
)
...
& "C:\Program Files\Microsoft Visual Studio\2022\Community\MSBuild\Current\Bin\MSBuild.exe" "${WorkspaceFolder}\BG3Tools.sln" "/p:Configuration=Release" /t:Clean,Build /m /nologo /verbosity:quiet /consoleloggerparameters:summary
