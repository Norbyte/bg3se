...
/// interpolation.
///
/// This class is used as part of a ObjectKeyFrameCollection in conjunction with a
/// ObjectAnimationUsingKeyFrames to animate a Object property value along a set of key frames.
///
/// A key frame defines a segment of the ObjectAnimationUsingKeyFrames to which it belongs. Each key
...
/// is reached.
///
/// Discrete key frames like DiscreteObjectKeyFrame create sudden "jumps" between values (no
...
protected:
    ...
    /// From KeyFrame
    //@{
    BaseComponent* InterpolateValueCore(BaseComponent* baseValue, float keyFrameProgress) override;
    //@}
