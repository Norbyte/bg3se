...
#ifndef __GUI_SPLINEINT64KEYFRAME_H__
#define __GUI_SPLINEINT64KEYFRAME_H__
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Animates from the *Int64* value of the previous key frame to its own *Value* using splined
/// interpolation.
///
...
/// is reached.
///
/// Spline key frames like SplineInt64KeyFrame creates a variable transition between values which is
...
///
/// http://msdn.microsoft.com/en-us/library/system.windows.media.animation.splineint64keyframe.aspx
////////////////////////////////////////////////////////////////////////////////////////////////////
class NS_GUI_ANIMATION_API SplineInt64KeyFrame final: public Int64KeyFrame
{
public:
    ...
    //@{
    Ptr<SplineInt64KeyFrame> Clone() const;
    Ptr<SplineInt64KeyFrame> CloneCurrentValue() const;
    //@}
...
protected:
    ...
    NS_DECLARE_REFLECTION(SplineInt64KeyFrame, Int64KeyFrame)
};
