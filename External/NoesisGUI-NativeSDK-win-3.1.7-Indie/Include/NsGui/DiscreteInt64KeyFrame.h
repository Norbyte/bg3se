...
#ifndef __GUI_DISCRETEINT64KEYFRAME_H__
#define __GUI_DISCRETEINT64KEYFRAME_H__
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Animates from the *Int64* value of the previous key frame to its own *Value* using discrete
/// interpolation.
///
...
/// is reached.
///
/// Discrete key frames like DiscreteInt64KeyFrame create sudden "jumps" between values (no
...
///
/// http://msdn.microsoft.com/en-us/library/system.windows.media.animation.discreteint64keyframe.aspx
////////////////////////////////////////////////////////////////////////////////////////////////////
class NS_GUI_ANIMATION_API DiscreteInt64KeyFrame final: public Int64KeyFrame
{
public:
    // Hides Freezable methods for convenience
    //@{
    Ptr<DiscreteInt64KeyFrame> Clone() const;
    Ptr<DiscreteInt64KeyFrame> CloneCurrentValue() const;
    //@}
...
protected:
    ...
    NS_DECLARE_REFLECTION(DiscreteInt64KeyFrame, Int64KeyFrame)
};
