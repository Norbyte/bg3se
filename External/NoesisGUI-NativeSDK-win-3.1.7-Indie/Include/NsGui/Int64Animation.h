...
#ifndef __GUI_INT64ANIMATION_H__
#define __GUI_INT64ANIMATION_H__
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Animates the value of a *Int64* property between two target values using linear interpolation
...
////////////////////////////////////////////////////////////////////////////////////////////////////
class NS_GUI_ANIMATION_API Int64Animation: public Int64AnimationBase
{
public:
    /// Gets or sets the total amount by which the animation changes its starting value
    //@{
    const Nullable<int64_t>& GetBy() const;
    void SetBy(const Nullable<int64_t>& by);
    //@}

    /// Gets or sets the animation's starting value
    //@{
    const Nullable<int64_t>& GetFrom() const;
    void SetFrom(const Nullable<int64_t>& from);
    //@}

    /// Gets or sets the animation's ending value
    //@{
    const Nullable<int64_t>& GetTo() const;
    void SetTo(const Nullable<int64_t>& to);
    //@}
    ...
    /// From Freezable
    //@{
    Ptr<Int64Animation> Clone() const;
    Ptr<Int64Animation> CloneCurrentValue() const;
    //@}
...
private:
    NS_DECLARE_REFLECTION(Int64Animation, Int64AnimationBase)
};
