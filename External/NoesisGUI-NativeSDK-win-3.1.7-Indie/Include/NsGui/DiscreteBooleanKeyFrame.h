...
/// interpolation.
///
/// This class is used as part of a BooleanKeyFrameCollection in conjunction with a
/// BooleanAnimationUsingKeyFrames to animate a Boolean property value along a set of key frames.
///
/// A key frame defines a segment of the BooleanAnimationUsingKeyFrames to which it belongs. Each
...
/// key time is reached.
///
/// Discrete key frames like DiscreteBooleanKeyFrame create sudden "jumps" between values (no
