...
P_FUN(GetStatusIds, (GameObjectGetStatusIds<esv::Character>))
P_FUN(GetStatuses, (GameObjectGetStatuses<esv::Character, esv::Status>))*/
END_CLS()
...
P(CustomDescription)
P_RO(StatsId)
// P_REF(Stats) - FIXME is this used at all?
P_REF(Generation)
P_RO(InventoryHandle)
P_RO(ParentHandle)
P(Amount)
...
P(field_484)
P_REF(SpellId)
// TODO - no handler - P_REF(PropertyListFunctor)
// TODO - MovingObject?
