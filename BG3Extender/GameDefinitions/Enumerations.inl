...
BEGIN_ENUM_NS(stats, RollType, StatsRollType, uint32_t)
	EV(None, 0)
	EV(Attack, 1)
...
BEGIN_BITMASK_NS(stats, ResurrectFlags, StatsResurrectFlags, uint8_t)
	EV(Living, 1)
	EV(Guaranteed, 2)
	EV(Construct, 4)
	EV(Undead, 8)
...
BEGIN_ENUM(BoostType, uint8_t)
	...
	E(ActionResourceOverride)
	E(AddProficiencyToAC)
	E(JumpMaxDistanceMultiplier)
	E(AddProficiencyToDamage)
	E(ActionResourceConsumeMultiplier)
	E(BlockVerbalComponent)
	E(BlockSomaticComponent)
	E(HalveWeaponDamage)
	E(Unused)
	E(UnlockSpell)
	E(SourceAdvantageOnAttack)
	E(ProficiencyBonus)
	E(BlockSpellCast)
	E(Proficiency)
	...
	E(Invulnerable)
	E(WeaponEnchantment)
	E(GuaranteedChanceRollOutcome)
	E(Attribute)
	E(IgnoreLeaveAttackRange)
	E(GameplayLight)
	E(DialogueBlock)
	E(DualWielding)
	E(Savant)
	...
	E(Invisibility)
	E(TwoWeaponFighting)
	E(WeaponAttackTypeOverride)
	E(WeaponDamageDieOverride)
	E(CarryCapacityMultiplier)
	E(WeaponProperty)
	E(WeaponAttackRollAbilityOverride)
	E(BlockTravel)
	E(BlockGatherAtCamp)
	E(BlockAbilityModifierDamageBonus)
	E(VoicebarkBlock)
	E(HiddenDuringCinematic)
	E(SightRangeAdditive)
	E(SightRangeMinimum)
	E(SightRangeMaximum)
	E(SightRangeOverride)
	E(CannotBeDisarmed)
	E(MovementSpeedLimit)
	E(NonLethal)
	E(UnlockSpellVariant)
	E(DetectDisturbancesBlock)
	E(BlockAbilityModifierFromAC)
	E(ScaleMultiplier)
	E(CriticalDamageOnHit)
	E(DamageReduction)
	E(ReduceCriticalAttackThreshold)
	E(PhysicalForceRangeBonus)
	E(ObjectSize)
	E(ObjectSizeOverride)
	E(ItemReturnToOwner)
	E(AiArchetypeOverride)
	E(ExpertiseBonus)
	E(EntityThrowDamage)
	E(WeaponDamageTypeOverride)
	E(MaximizeHealing)
	E(IgnoreEnterAttackRange)
	E(DamageBonus)
	E(Detach)
	E(ConsumeItemBlock)
	E(AdvanceSpells)
	...
	E(CanShootThrough)
	E(CanWalkThrough)
	E(MonkWeaponAttackOverride)
	E(MonkWeaponDamageDiceOverride)
	E(IntrinsicSummonerProficiency)
	E(HorizontalFOVOverride)
	E(CharacterUnarmedDamage)
	E(UnarmedMagicalProperty)
	E(ActionResourceReplenishTypeOverride)
	E(AreaDamageEvade)
	E(ActionResourcePreventReduction)
	E(AttackSpellOverride)
	E(Lock)
	E(NoAOEDamageOnLand)
	E(IgnorePointBlankDisadvantage)
	E(CriticalHitExtraDice)
	E(DodgeAttackRoll)
	E(GameplayObscurity)
	E(MaximumRollResult)
	E(UnlockInterrupt)
	E(IntrinsicSourceProficiency)
	E(JumpMaxDistanceBonus)
	E(ArmorAbilityModifierCapOverride)
	E(IgnoreResistance)
	E(ConcentrationIgnoreDamage)
	E(LeaveTriggers)
	E(IgnoreLowGroundPenalty)
	E(IgnoreSurfaceCover)
	E(EnableBasicItemInteractions)
	E(SoundsBlocked)
END_ENUM()
