...
BEGIN_ENUM(ExtComponentType, uint32_t)
	...
	E(DifficultyCheck)
	E(ObjectSize)
	E(InventoryMemberComponent)
	E(InventoryDataComponent)
	E(InventoryOwnerComponent)
	E(InventoryContainerComponent)
...
BEGIN_ENUM(BoostType, uint8_t)
	...
	EV(ActiveCharacterLight, 0x3F)
	EV(Invisibility, 0x40)
	EV(TwoWeaponFighting, 0x41)
	EV(WeaponAttackTypeOverride, 0x42)
	EV(WeaponDamageDieOverride, 0x43)
	EV(CarryCapacityMultiplier, 0x44)
	EV(WeaponProperty, 0x45)
	EV(WeaponAttackRollAbilityOverride, 0x46)
	EV(BlockTravel, 0x47)
	EV(BlockGatherAtCamp, 0x48)
	EV(BlockAbilityModifierDamageBonus, 0x49)
	EV(VoicebarkBlock, 0x4A)
	EV(HiddenDuringCinematic, 0x4B)
	EV(SightRangeAdditive, 0x4C)
	EV(SightRangeMinimum, 0x4D)
	EV(SightRangeOverride, 0x4E)
