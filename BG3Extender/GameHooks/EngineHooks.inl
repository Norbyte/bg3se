...
*/
HOOK_DEFN(RPGStats__Load, RPGStats__Load, RPGStats::LoadProc)

HOOK_DEFN(FileReader__ctor, ls__FileReader__ctor, FileReader::CtorProc)
HOOK_DEFN(DealDamageFunctor__ApplyDamage, eoc__DealDamageFunctor__ApplyDamage, DealDamageFunctor::ApplyDamageProc)
HOOK_DEFN(StatsFunctorSet__ExecuteType1, eoc__StatsFunctorSet__ExecuteType1, StatsFunctorSet::ExecuteType1Proc)
HOOK_DEFN(StatsFunctorSet__ExecuteType2, eoc__StatsFunctorSet__ExecuteType2, StatsFunctorSet::ExecuteType2Proc)
HOOK_DEFN(StatsFunctorSet__ExecuteType3, eoc__StatsFunctorSet__ExecuteType3, StatsFunctorSet::ExecuteType3Proc)
HOOK_DEFN(StatsFunctorSet__ExecuteType4, eoc__StatsFunctorSet__ExecuteType4, StatsFunctorSet::ExecuteType4Proc)
HOOK_DEFN(StatsFunctorSet__ExecuteType5, eoc__StatsFunctorSet__ExecuteType5, StatsFunctorSet::ExecuteType5Proc)
HOOK_DEFN(StatsFunctorSet__ExecuteType6, eoc__StatsFunctorSet__ExecuteType6, StatsFunctorSet::ExecuteType6Proc)
HOOK_DEFN(StatsFunctorSet__ExecuteType7, eoc__StatsFunctorSet__ExecuteType7, StatsFunctorSet::ExecuteType7Proc)
HOOK_DEFN(StatsFunctorSet__ExecuteType8, eoc__StatsFunctorSet__ExecuteType8, StatsFunctorSet::ExecuteType8Proc)
