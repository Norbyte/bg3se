...
TYPECHECK(char const*, LUA_TBOOLEAN)
TYPECHECK(FixedString, LUA_TBOOLEAN)
TYPECHECK(FixedStringNoRef, LUA_TBOOLEAN)
TYPECHECK(STDString, LUA_TBOOLEAN)
TYPECHECK(StringView, LUA_TBOOLEAN)
TYPECHECK(LSStringView, LUA_TBOOLEAN)
TYPECHECK(ScratchBuffer, LUA_TBOOLEAN)
TYPECHECK(ScratchString, LUA_TBOOLEAN)
TYPECHECK(Noesis::String, LUA_TBOOLEAN)
TYPECHECK(Noesis::Symbol, LUA_TBOOLEAN)
TYPECHECK(STDWString, LUA_TBOOLEAN)
TYPECHECK(Path, LUA_TBOOLEAN)
